...
class CurrencyUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => ['required', 'string', 'max:100', Rule::unique('currencies', 'name')->ignore($this->currency, 'id')],
            ...
            'iso_code' => ['required', 'string', 'size:3', Rule::unique('currencies', 'iso_code')->ignore($this->currency, 'id'), 'alpha', 'uppercase'],
        ];
    }
