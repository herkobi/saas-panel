...
class FeatureManager
{
    ...
    public function __construct(protected SubscriptionService $subscriptionService, protected NotificationService $notificationService)
    {
    }
     ...
     */
    private function getFeatureBySlug(string $slug)
    {
