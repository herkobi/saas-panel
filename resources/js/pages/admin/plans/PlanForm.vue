                ...
                <div class="space-y-4 lg:col-span-2">
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            <!-- İsim Alanı ve Ücretsiz Plan Seçimi (tek satırda) -->
                        ...
                        <CardContent class="space-y-5">
                            ...
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                ...
                                <div class="space-y-1" v-if="formData.billing_period !== 'monthly'">
                                    ...
                                    <Input id="yearly_price" v-model="formData.yearly_price" type="number" min="0" step="0.01" class="h-8 text-sm" />
                                    <InputError :message="formData.errors.yearly_price" />
                                </div>
                            </div>

                            <!-- 3. Ülke, Para Birimi ve Vergi -->
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="relative">
                                        <Select v-model="formData.country_code">
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    <SelectItem v-if="formData.country_code" value="none" key="default-option">Ülke seçin</SelectItem>
                                                    <SelectSeparator />
                                    ...
                                    <div class="relative">
                                        <Select v-model="formData.currency_code">
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectSeparator />
                                                <SelectGroup>
                                                    <SelectItem v-for="currency in currencies" :key="currency.iso_code" :value="currency.iso_code">
                            ...
                            <!-- 5. Deneme ve Grace Süresi (Tek Satırda) -->
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <div class="space-y-1">
