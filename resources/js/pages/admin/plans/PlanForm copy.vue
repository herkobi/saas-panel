...
import { ArrowLeftIcon, CircleX, LoaderCircle, Plus, RotateCcw, Save, Trash2 } from 'lucide-vue-next';
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-3">
                            ...
                            <div class="grid grid-cols-1 gap-3 space-y-1 sm:grid-cols-2">
                                ...
                                <div class="space-y-1" v-if="!formData.is_free">
                            ...
                            <!-- Fiyatlar -->
                            <div v-if="!formData.is_free" class="grid grid-cols-1 gap-3 space-y-1 sm:grid-cols-2">
