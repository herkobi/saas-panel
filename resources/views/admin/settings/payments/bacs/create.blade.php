    ...
    <div class="page-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <h3 class="form-title border-bottom mb-3 pb-3">Yeni Banka Havalesi / EFT Bilgisi</h3>
                    <form action="{{ route('panel.settings.payments.bac.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-lg-10 col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="account_number" id="account_number"
                                        class="form-control rounded-0 border-start-0" placeholder="Hesap Numarasını Giriniz"
                            ...
                            <div class="col-lg-10 col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="iban" id="iban"
                                        ...
                                        placeholder="IBAN Numarasını Giriniz" value="{{ old('iban') }}">
                                </div>
