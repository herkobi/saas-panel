<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            ...
            <form action="{{ route('panel.settings.currency.update', $currency->id) }}" class="form" method="post">
                @csrf
                            ...
                            @foreach (Status::values() as $key => $value)
                                <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                    <input
                                        ...
                                        {{ $currency->status->value == $key ? 'checked' : '' }} />
                ...
                <div class="mb-4 grid gap-4 grid-cols-12">
                    ...
                    <div class="relative col-span-9">
                        ...
                        <x-input type="text" id="title" name="title"
                            ...
                            placeholder="{{ __('admin/settings/currencies.form.title') }}" :value="$currency->title ? $currency->title : old('title')" required
                            autocomplete="title" />
                            ...
                            <div class="col-span-6">
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="code" name="code"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/settings/currencies.form.code') }}" :value="$currency->code ? $currency->code : old('code')"
                            ...
                            <div class="col-span-6">
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="symbol" name="symbol"
                                        ...
                                        :value="$currency->symbol ? $currency->symbol : old('symbol')" required autocomplete="symbol" />
                    ...
                    <div class="col-start-4 col-span-9">
                        <div class="flex items-center justify-between">
                            <x-submit
                                ...
                                {{ __('admin/settings/currencies.form.update') }}
                            </x-submit>
                            <x-button data-hs-overlay="#confirm-modal"
                                ...
                                {{ __('admin/settings/currencies.delete.button') }}
                            </x-button>
                        </div>
                    </div>
                </div>
            ...
            <div
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                {{ __('admin/settings/currencies.confirm.title') }}
                            </h3>
                            <p class="text-gray-500">
                                {{ __('admin/settings/currencies.confirm.text') }}
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <x-button
                        ...
                        data-hs-overlay="#confirm-modal">
                        {{ __('admin/settings/currencies.confirm.cancel') }}
                    </x-button>
                    <form method="post" action="{{ route('panel.settings.currency.destroy', $currency->id) }}">
                        @csrf
                        <x-submit
                            ...
                            href="#">
                            {{ __('admin/settings/currencies.confirm.submit') }}
                        </x-submit>
                    </form>
                </div>
            </div>
