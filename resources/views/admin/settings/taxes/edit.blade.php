<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            ...
            <form action="{{ route('panel.settings.tax.update', $tax->id) }}" class="form" method="post">
                @csrf
                ...
                <div class="mb-4 grid gap-4 grid-cols-12">
                    ...
                    <div class="relative col-span-9">
                        ...
                        <x-input type="text" id="title" name="title"
                            ...
                            placeholder="{{ __('admin/settings/taxes.form.title') }}" :value="$tax->title ? $tax->title : old('title')" required
                            autocomplete="title" />
                            ...
                            <div class="col-span-3">
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="value" name="value"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/settings/taxes.form.value') }}" :value="$tax->value ? $tax->value : old('value')"
                            ...
                            <div class="col-span-9">
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="desc" name="desc"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/settings/taxes.form.desc') }}" :value="$tax->desc ? $tax->desc : old('desc')"
                    ...
                    <div class="col-start-4 col-span-9">
                        <div class="flex items-center justify-between">
                            <x-submit
                                ...
                                {{ __('admin/settings/taxes.form.update') }}
                            </x-submit>
                            <x-button data-hs-overlay="#confirm-modal"
                                ...
                                {{ __('admin/settings/taxes.form.delete') }}
                            </x-button>
                        </div>
                    </div>
                </div>
    ...
    <div id="confirm-modal"
        class="hs-overlay hs-overlay-taxkdrop-open:bg-blue-950/90 hidden w-full h-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto [--overlay-taxkdrop:static]"
            ...
            <div
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                {{ __('admin/settings/taxes.confirm.title') }}
                            </h3>
                            <p class="text-gray-500">
                                {{ __('admin/settings/taxes.confirm.text') }}
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <x-button
                        ...
                        data-hs-overlay="#confirm-modal">
                        {{ __('admin/settings/taxes.confirm.cancel') }}
                    </x-button>
                    <form method="post" action="{{ route('panel.settings.tax.destroy', $tax->id) }}">
                        @csrf
                        <x-submit
                            ...
                            href="#">
                            {{ __('admin/settings/taxes.confirm.submit') }}
                        </x-submit>
                    </form>
                </div>
            </div>
