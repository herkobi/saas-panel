<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            <h1 class="mb-8 text-xl	font-medium	border-b pb-2">{{ __('admin/settings/pages.edit.page.title') }}</h1>
            <form action="{{ route('panel.settings.page.update', $page->id) }}" class="form" method="post">
                @csrf
                <div class="mb-4 grid gap-4 grid-cols-12">
                    <x-label for="status" class="block font-medium text-gray-700 col-span-3" :value="__('admin/settings/pages.form.status')" />
                    <div class="col-span-9">
                ...
                <div class="mb-4 grid gap-4 grid-cols-12">
                    <x-label for="title" class="block font-medium text-sm text-gray-700 col-span-3"
                        :value="__('admin/settings/pages.form.title')" />
                    <div class="relative col-span-9">
                        ...
                        <x-input type="text" id="title" name="title"
                            ...
                            placeholder="{{ __('admin/settings/pages.form.title') }}" :value="$page->title ? $page->title : old('title')" required
                            autocomplete="title" />
                ...
                <div class="mb-4 grid gap-4 grid-cols-12">
                    <x-label for="desc" class="block font-medium text-sm text-gray-700 col-span-3"
                        :value="__('admin/settings/pages.form.text')" />
                    <div class="relative col-span-9">
                        <x-textarea id="text" name="text" required
                            aria-autocomplete="text">{{ $page->text }}</x-textarea>
                    ...
                    <div class="col-start-4 col-span-9">
                        <div class="flex items-center justify-between">
                            <x-submit
                                ...
                                {{ __('admin/settings/pages.form.update') }}
                            </x-submit>
                            <x-button data-hs-overlay="#confirm-modal"
                                ...
                                {{ __('admin/settings/pages.delete.button') }}
                            </x-button>
                        </div>
                    </div>
                </div>
            ...
            <div
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                {{ __('admin/settings/pages.confirm.title') }}
                            </h3>
                            <p class="text-gray-500">
                                {{ __('admin/settings/pages.confirm.text') }}
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <x-button
                        ...
                        data-hs-overlay="#confirm-modal">
                        {{ __('admin/settings/pages.confirm.cancel') }}
                    </x-button>
                    <form method="post" action="{{ route('panel.settings.page.destroy', $page->id) }}">
                        @csrf
                        <x-submit
                            ...
                            href="#">
                            {{ __('admin/settings/pages.confirm.submit') }}
                        </x-submit>
                    </form>
                </div>
            </div>
