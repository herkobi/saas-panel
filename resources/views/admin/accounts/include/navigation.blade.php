        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-start">
                    ...
                    <li
                        class="nav-item {{ request()->routeIs(['panel.accounts', 'panel.account.*']) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('panel.accounts') }}" title="Müşteri Grupları">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <li class="nav-item {{ request()->routeIs(['panel.orders', 'panel.order.*']) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('panel.orders') }}" title="Ödemeler">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
