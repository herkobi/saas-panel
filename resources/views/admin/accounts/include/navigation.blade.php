            ...
            <div class="col-lg-12">
                <ul class="nav justify-content-start">
                    <li class="nav-item {{ request()->routeIs(['panel.accounts', 'panel.account.*']) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('panel.accounts') }}" title="Müşteriler">
                    ...
                    <li
                        class="nav-item {{ request()->routeIs(['panel.accountgroups', 'panel.accountgroup.*']) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('panel.accountgroups') }}" title="Müşteri Grupları">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-bookmarks" viewBox="0 0 20 20">
                                <path
