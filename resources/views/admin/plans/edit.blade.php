                ...
                <div class="col-lg-9">
                    <div class="page-form row">
                        <div class="col-lg-10 offset-lg-1">
                            <h3 class="form-title border-bottom mb-3 pb-2">Plan Bilgilerini Düzenle</h3>
                                ...
                                <div class="row align-self-start mb-3">
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <div class="row mb-3 mt-2">
                                            ...
                                            <div id="tenant_select_container" class="col-lg-6"
                                                style="{{ $plan->base ? 'display:block;' : 'display:none;' }}">
                                                <select class="form-select" name="base" id="tenant_select">
                                                    <option value="">Hesap Seçiniz...</option>
                                                    @foreach ($tenants as $tenant)
                                                        <option value="{{ $tenant->id }}"
                                                            {{ $plan->base == $tenant->id ? 'selected' : '' }}>
                                                            {{ $tenant->code }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input id="name" type="text" name="name"
                                                ...
                                                placeholder="Plan Adını Giriniz" value="{{ old('name', $plan->name) }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input id="desc" type="text" name="desc"
                                                class="form-control rounded-0 border-start-0"
                                                placeholder="Plan Açıklamasını Giriniz"
                                                value="{{ old('desc', $plan->description) }}">
                                        </div>
                                                            ...
                                                            <select class="form-select border-0" id="currency_id"
                                                                ...
                                                                @foreach ($currencies as $currency)
                                                                    <option value="{{ $currency->id }}"
                                                                        {{ $currency->id == $plan->currency_id ? 'selected' : '' }}>
                                                                        ({{ $currency->symbol }})
                                                                    </option>
                                                                @endforeach
                                                            </select>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <button type="button" class="btn bg-white border-0 text-dark" data-bs-dismiss="modal">İptal
                                Et</button>
                            <button type="submit" class="btn">Evet, Planı Sil</button>
                        </div>
                    </div>
                </form>
            </div>
...
@section('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const baseValue = "{{ $plan->base }}"; // Mevcut planın base değeri
            if (baseValue) {
                forTenantCheckbox.checked = true;
                tenantSelectContainer.style.display = 'block';
            } else {
                forTenantCheckbox.checked = false;
