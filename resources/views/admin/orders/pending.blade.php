                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($order->document)
                                                @if (pathinfo($order->document, PATHINFO_EXTENSION) === 'pdf')
                                                    <a href="{{ Storage::url($order->document) }}" class="btn btn-sm"
                                                        target="_blank">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                @if ($order->document)
                                                    <form action="{{ route('panel.order.approve', $order->code) }}"
                                                        method="POST">
                                                        @csrf
                                                    ...
                                                    <form action="{{ route('panel.order.reject', $order->code) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm btn-danger border-top-left-radius border-bottom-left-radius"
