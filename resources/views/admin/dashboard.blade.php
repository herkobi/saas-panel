<x-admin-app-layout>
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <header class="max-w-3xl">
            ...
            <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Dark Application Layout
                Navbar/Header using Tailwind CSS</h1>
            <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">This is a simple application layout with header only
                example using Tailwind CSS.</p>
            <div class="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
                ...
                <a class="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="../examples.html">
                    <svg class="flex-shrink-0 w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16"
                        fill="none">
                        <path
