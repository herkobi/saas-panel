<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            <h1 class="mb-8 text-xl	font-medium	border-b pb-2">{{ __('admin/features/features.edit.page.title') }}</h1>
            <form action="{{ route('panel.plans.feature.update', $feature->id) }}" class="form" method="post">
                @csrf
                                    ...
                                    @foreach (Status::values() as $key => $value)
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                ...
                                                value="{{ $key }}"
                                                {{ $key == $feature->status->value ? 'checked' : '' }} />
                        ...
                        <div class="relative mb-4">
                            ...
                            <div class="relative">
                                ...
                                <x-input type="text" id="title" name="title"
                                    ...
                                    placeholder="{{ __('admin/features/features.form.title') }}" :value="$feature->title"
                            ...
                            <div class="md:col-span-6">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="number" id="periodicity" name="periodicity" min="0"
                                        step="1"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        :value="$feature->periodicity" required autocomplete="periodicity" />
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <select
                                        ...
                                        @foreach (Period::values() as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ $key == $feature->periodicity_type->value ? 'selected' : '' }}>
                                    ...
                                    <div id="consumable" class="flex justify-start">
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                ...
                                                value="1" {{ 1 == $feature->consumable ? 'checked' : '' }} />
                                        ...
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                ...
                                                value="0" {{ 0 == $feature->consumable ? 'checked' : '' }} />
                                ...
                                <div class="col-span-9">
                                    <div id="postpaid" class="flex justify-start">
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                class="relative float-left -ml-[1.5rem] mr-1 mt-0.5 h-5 w-5 appearance-none rounded-full border-2 border-solid border-neutral-300 before:pointer-events-none before:absolute before:h-4 before:w-4 before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] after:absolute after:z-[1] after:block after:h-4 after:w-4 after:rounded-full after:content-[''] checked:border-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:left-1/2 checked:after:top-1/2 checked:after:h-[0.625rem] checked:after:w-[0.625rem] checked:after:rounded-full checked:after:border-primary checked:after:bg-primary checked:after:content-[''] checked:after:[transform:translate(-50%,-50%)] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:outline-none focus:ring-0 focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:border-primary checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] dark:border-neutral-600 dark:checked:border-primary dark:checked:after:border-primary dark:checked:after:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:border-primary dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca]"
                                                type="radio" name="postpaid" id="active-postpaid" value="1"
                                                {{ 1 == $feature->postpaid ? 'checked' : '' }} />
                                        ...
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                class="relative float-left -ml-[1.5rem] mr-1 mt-0.5 h-5 w-5 appearance-none rounded-full border-2 border-solid border-neutral-300 before:pointer-events-none before:absolute before:h-4 before:w-4 before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] after:absolute after:z-[1] after:block after:h-4 after:w-4 after:rounded-full after:content-[''] checked:border-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:left-1/2 checked:after:top-1/2 checked:after:h-[0.625rem] checked:after:w-[0.625rem] checked:after:rounded-full checked:after:border-primary checked:after:bg-primary checked:after:content-[''] checked:after:[transform:translate(-50%,-50%)] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:outline-none focus:ring-0 focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:border-primary checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] dark:border-neutral-600 dark:checked:border-primary dark:checked:after:border-primary dark:checked:after:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:border-primary dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca]"
                                                type="radio" name="postpaid" id="passive-postpaid" value="0"
                                                {{ 0 == $feature->postpaid ? 'checked' : '' }} />
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-3">
                    <div class="relative md:col-span-2 md:col-start-2 mt-6">
                        <div class="flex items-center justify-between">
                            <x-submit
                                ...
                                {{ __('admin/features/features.form.update') }}
                            </x-submit>
                            <x-button data-hs-overlay="#confirm-modal"
                                ...
                                {{ __('admin/features/features.form.delete') }}
                            </x-button>
                        </div>
                    </div>
                </div>
            ...
            <div
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                {{ __('admin/features/features.confirm.title') }}
                            </h3>
                            <p class="text-gray-500">
                                {{ __('admin/features/features.confirm.text') }}
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <x-button
                        ...
                        data-hs-overlay="#confirm-modal">
                        {{ __('admin/features/features.confirm.cancel') }}
                    </x-button>
                    <form method="post" action="{{ route('panel.plans.feature.destroy', $feature->id) }}">
                        @csrf
                        <x-submit
                            ...
                            href="#">
                            {{ __('admin/features/bac.confirm.submit') }}
                        </x-submit>
                    </form>
                </div>
            </div>
