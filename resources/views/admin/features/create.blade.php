<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            <h1 class="mb-8 text-xl	font-medium	border-b pb-2">{{ __('admin/plans/features.create.page.title') }}</h1>
            <form action="{{ route('panel.plans.feature.create.store') }}" class="form" method="post">
                @csrf
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    <div class="text-gray-900 mb-4">
                        <p class="font-medium text-lg">{{ __('admin/plans/features.feature.title') }}</p>
                        <p class="text-sm text-gray-600">{{ __('admin/plans/features.feature.text') }}</p>
                    </div>
                    <div class="lg:col-span-2">
                        <div class="relative mb-4">
                            <x-label for="status" class="block font-medium text-gray-700 col-span-3"
                                :value="__('admin/plans/features.form.status')" />
                            <div class="col-span-9">
                        ...
                        <div class="relative mb-4">
                            <x-label for="title" class="block font-medium text-sm text-gray-700" :value="__('admin/plans/features.form.title')" />
                            <div class="relative">
                                ...
                                <x-input type="text" id="title" name="title"
                                    ...
                                    placeholder="{{ __('admin/plans/features.form.title') }}" :value="old('title')" required
                                    autocomplete="title" />
                            </div>
                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-12 mb-4">
                            <div class="md:col-span-6">
                                <x-label for="price" class="block font-medium text-sm text-gray-700"
                                    :value="__('admin/plans/features.form.price')" />
                                <div class="relative">
                                    <div
                                    ...
                                    <x-input type="text" id="price" name="price"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/plans/features.form.price') }}" :value="old('price')"
                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-12 mb-4">
                            <div class="md:col-span-6">
                                <x-label for="periodicity" class="block font-medium text-sm text-gray-700"
                                    :value="__('admin/plans/features.form.periodicity')" />
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                                        <svg class="flex-shrink-0 h-4 w-4 text-gray-600"
                                    ...
                                    <x-input type="number" id="periodicity" name="periodicity" min="0"
                                        step="1"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/plans/features.form.periodicity') }}"
                            ...
                            <div class="md:col-span-6 mb-4">
                                <x-label for="periodicity_type" class="block font-medium text-sm text-gray-700"
                                    :value="__('admin/plans/features.form.periodicity_type')" />
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                                        <svg class="flex-shrink-0 h-4 w-4 text-gray-600"
                            ...
                            <div class="md:col-span-6">
                                <x-label for="grace_days" class="block font-medium text-sm text-gray-700"
                                    :value="__('admin/plans/features.form.grace_days')" />
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                                        <svg class="flex-shrink-0 h-4 w-4 text-gray-600"
                                    ...
                                    <x-input type="number" id="grace_days" name="grace_days" min="0"
                                        step="1"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/plans/features.form.grace_days') }}"
                                        :value="old('grace_days')" required autocomplete="grace_days" />
                                </div>
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-3">
                    <div class="relative md:col-span-1 md:col-start-2 mt-6">
                        <x-submit
                            ...
                            {{ __('admin/plans/features.form.submit') }}
                        </x-submit>
                    </div>
                </div>
            </form>
