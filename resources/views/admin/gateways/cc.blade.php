                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">
                                    {{ __('admin/gateways/cc.page.title') }}
                                </h2>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ __('admin/gateways/cc.page.text') }}
                                </p>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-start">
                                        <div class="flex items-center gap-x-2">
                                            <span
                                                ...
                                                {{ __('admin/gateways/cc.table.status') }}
                                            </span>
                                        </div>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-start">
                                    ...
                                    <th scope="col" class="px-6 py-3 text-start">
                                        <div class="flex items-center gap-x-2">
                                            <span
                                                class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200">
                                                {{ __('admin/gateways/cc.table.bank') }}
                                            </span>
                                        </div>
                                    </th>
                                ...
                                @foreach ($gateways as $key => $gateway)
                                    <tr>
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $gateway->currency->title }}</span>
                                            </div>
                                        </td>
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="flex items-start justfiy-between px-6 py-1.5 gap-2">
                                                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                                    href="{{ route('panel.gateways.' . $values[$key]['code'] . '.edit', $gateway->id) }}">
                                                    {{ __('admin/gateways/cc.table.edit') }}
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
