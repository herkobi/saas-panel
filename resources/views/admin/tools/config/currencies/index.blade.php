                    ...
                    <div class="row align-items-center mb-2">
                        ...
                        <div class="col-lg-6">
                            <ul class="nav justify-content-end">
                                <li class="nav-item">
                                    <a href="{{ route('panel.tools.config.currency.create') }}" class="btn"
                                    ...
                                    <tr>
                                        <td>
                                            @if ($currency->status->value == 1)
                                                <span class="badge bg-success">{{ Status::title($currency->status) }}</span>
                                            @else
                                                <span class="badge bg-danger">{{ Status::title($currency->status) }}</span>
                                            @endif
                                        </td>
                                        <td>{{ $currency->name }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('panel.tools.config.currency.edit', $currency->id) }}"
                                                class="btn btn-sm" title="Para Birimi Bilgileri">
                                                Düzenle
                                            </a>
                                        </td>
                                    </tr>
