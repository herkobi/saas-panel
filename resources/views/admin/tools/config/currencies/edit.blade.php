    ...
    <div class="page-content">
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-9">
                    <h3 class="form-title border-bottom mb-3 pb-3">Para Birimi Bilgilerini Güncelle</h3>
                    <form action="{{ route('panel.tools.config.currency.update', $currency->id) }}" method="POST">
                        @csrf
                                    ...
                                    @foreach (Status::cases() as $type)
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status"
                                                value="{{ $type->value }}"
                                                {{ $type->value == $currency->status->value ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-10 col-md-9">
                                <div class="input-group">
                                    ...
                                    <input id="name" type="text" name="name"
                                        ...
                                        placeholder="Para Birimi Adını Giriniz" value="{{ old('name', $currency->name) }}"
                                        required>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select id="symbol_position" name="symbol_position" class="form-select" required>
                                            <option value="left"
                                                {{ $currency->symbol_position === 'left' ? 'selected' : '' }}>Solda</option>
                                            <option value="right"
                                                {{ $currency->symbol_position === 'right' ? 'selected' : '' }}>Sağda
                                            </option>
                                            <option value="left_space"
                                                {{ $currency->symbol_position === 'left_space' ? 'selected' : '' }}>Solda
                                                Boşlukla</option>
                                            <option value="right_space"
                                                {{ $currency->symbol_position === 'right_space' ? 'selected' : '' }}>Sağda
                                                Boşlukla</option>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text rounded-0 border-end-0 bg-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-input-cursor-text" viewBox="0 0 16 16">
                                            ...
                                            <input id="thousands_separator" type="text" name="thousands_separator"
                                                class="form-control rounded-0 border-start-0" placeholder="Binlik Ayırıcı"
                                                value="{{ old('thousands_separator', $currency->thousands_separator) }}"
                                                required>
                                        </div>
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text rounded-0 border-end-0 bg-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-input-cursor" viewBox="0 0 16 16">
                                                    <path
                                                        d="M10 5h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4v1h4a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-4zM6 5V4H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v-1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z">
                                                    </path>
                                                    <path fill-rule="evenodd"
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="decimal_digits" type="number" name="decimal_digits"
                                                ...
                                                value="{{ old('decimal_digits', $currency->decimal_digits) }}" required>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="iso_code" type="text" name="iso_code"
                                                ...
                                                value="{{ old('iso_code', $currency->iso_code) }}" required>
                                        </div>
                                        <span class="form-hint small">Para birimine ait ISO kodunu giriniz. ISO
                                            kod listesine <a href="https://en.wikipedia.org/wiki/ISO_4217" target="_blank"
                                                rel="noopener">bu adresten</a>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('panel.tools.config.currency.delete', $currency->id) }}" method="post">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="modal-body">
                        <strong>{{ $currency->name }}</strong> isimli para birimini silmek üzeresiniz. Bu işlem geri
                    ...
                    <div class="modal-footer">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <button type="button" class="btn bg-white border-0 text-dark" data-bs-dismiss="modal">İptal
                                Et</button>
                            <button type="submit" class="btn">Evet, Para Birimini Sil</button>
                        </div>
                    </div>
                </form>
            </div>
