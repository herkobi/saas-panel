    ...
    <div class="page-content">
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-9">
                    <div class="page-form">
                        <h3 class="form-title border-bottom mb-3 pb-3">Yeni Eyalet/Şehir</h3>
                        <form action="{{ route('panel.tools.config.state.store', $country->id) }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" id="name"
                                            ...
                                            placeholder="Eyalet/Şehir Adını Giriniz" value="{{ old('name') }}" required>
                                    </div>
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="code" id="code"
                                            class="form-control rounded-0 border-start-0"
                                            placeholder="Eyalet/Şehir Kodunu Giriniz" value="{{ old('code') }}" required>
                                    </div>
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            class="form-control rounded-0 border-start-0"
                                            placeholder="Telefon Kodunu Giriniz" value="{{ old('phone') }}" required>
                                    </div>
