            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-9">
                    <div class="page-form">
                        ...
                        <form action="{{ route('panel.tools.config.orderstatus.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="title" id="title"
                                            ...
                                            placeholder="Ödeme Durumunu Giriniz" value="{{ old('title') }}" required>
                                    </div>
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control rounded-0 border-start-0" rows="2"
                                            placeholder="Ödeme Durumu Açıklaması" required>{{ old('description') }}</textarea>
                                    </div>
