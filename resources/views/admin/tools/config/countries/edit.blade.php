                                ...
                                <div class="col-lg-10 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            ...
                                            placeholder="Telefon Kodunu Giriniz" value="{{ old('phone', $country->phone) }}"
                                            required>
                                    </div>
                                    <span class="form-hint small">Ülke telefon kodunu giriniz</span>
                                    @error('phone')
                                        <div class="invalid-feedback" role="alert">Lütfen ülke telefon kodunu giriniz</div>
                                    @enderror
                                </div>
                            </div>
                            <div class="row mb-3">
