<nav class="sticky -top-px bg-white text-sm font-medium text-black ring-1 ring-gray-900 ring-opacity-5 shadow-sm shadow-gray-100 pt-4 pb-4 -mt-px dark:bg-slate-900 dark:border-gray-800 dark:shadow-slate-700/[.7]"
    ...
    <div
        ...
        <div class="snap-center shrink-0">
            <div class="relative">
                <a class="flex items-center gap-x-2 py-2 px-3 text-sm text-slate-700 font-medium me-1 hover:bg-gray-100 hover:rounded-lg {{ request()->routeIs('panel.dashboard') ? 'bg-gray-100 rounded-lg' : '' }}"
