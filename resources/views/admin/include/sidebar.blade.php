<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li {{ request()->routeIs('panel.accounts') ? 'class=active' : '' }}>
            <a href="{{ route('panel.accounts') }}" title="Abonelikler">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="bi bi-person-check" viewBox="0 0 20 20">
                    <path
        ...
        <li class="title">Planlar</li>
        <li {{ request()->routeIs(['panel.plans', 'panel.plan.*']) ? 'class=active' : '' }}>
            <a href="{{ route('panel.plans') }}" title="Kullanıcı Planları">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        ...
        <li {{ request()->routeIs(['panel.features', 'panel.feature.*']) ? 'class=active' : '' }}>
            <a href="{{ route('panel.features') }}" title="Plan Özellikleri">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
        ...
        <li {{ request()->routeIs('panel.settings.payments.*') ? 'class=active' : '' }}>
            <a href="{{ route('panel.settings.payments.bacs') }}" title="Ödeme Yöntemleri">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="bi bi-credit-card-2-front" viewBox="0 0 20 20">
                    <path
                        d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z" />
        ...
        <li
            {{ request()->routeIs(['panel.settings.agreements.*', 'panel.settings.agreement.*', 'panel.settings.agreement.versions.*']) ? 'class=active' : '' }}>
            <a href="{{ route('panel.settings.agreements.user') }}" title="Sözleşmeler">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
