<x-admin-app-layout>
    <div class="grid grid-cols-12 gap-7">
        ...
        <div class="col-span-9">
            <h1 class="mb-8 text-xl	font-medium	border-b pb-2">{{ __('admin/users/users.create.page.title') }}</h1>
                            ...
                            <div class="md:col-span-6">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="name" name="name"
                                        ...
                                        placeholder="{{ __('admin/users/users.form.name') }}" :value="old('name')" required
                                        autocomplete="name" />
                                </div>
                            ...
                            <div class="md:col-span-6">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="surname" name="surname"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/users/users.form.surname') }}" :value="old('surname')"
                        ...
                        <div class="relative mb-4">
                            ...
                            <div class="relative">
                                ...
                                <x-input type="text" id="title" name="title"
                                    class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                    placeholder="{{ __('admin/users/users.form.title') }}" :value="old('title')" required
                                    autocomplete="title" />
                            </div>
                    ...
                    <div class="lg:col-span-2">
                            ...
                            <div class="md:col-span-6">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="email" id="email" name="email"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/users/users.form.email') }}" :value="old('email')"
                            ...
                            <div class="md:col-span-6">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input type="text" id="username" name="username"
                                        class="py-2 px-4 ps-11 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        placeholder="{{ __('admin/users/users.form.username') }}" :value="old('username')"
                        ...
                        <div class="relative">
                            <x-label for="password" class="block font-medium text-sm text-gray-700"
                                :value="__('admin/users/users.form.password')" />
                            <div class="relative">
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-3">
                    <div class="relative md:col-span-1 md:col-start-2 mt-6">
                        <x-submit
                            ...
                            {{ __('admin/users/users.form.submit') }}
                        </x-submit>
                    </div>
                </div>
            </form>
