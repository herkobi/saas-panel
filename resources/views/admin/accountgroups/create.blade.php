        ...
        <div class="container">
            <div class="page-form row">
                <div class="col-lg-10 offset-lg-1">
                    <h3 class="form-title border-bottom mb-3 pb-3">Yeni Müşteri Grubu</h3>
                    <form action="{{ route('panel.accountgroup.store') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        placeholder="Müşteri Grubu Adını Giriniz" value="{{ old('title') }}" required>
                                </div>
