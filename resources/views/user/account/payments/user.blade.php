    ...
    <div class="auth-form big-form">
        <div class="card shadow-sm">
            <div class="card-body p-3">
                ...
                <h2 class="form-title position-relative pb-3">Hesap Erişiminiz Kısıtlandı</h2>
                <p class="text-muted mb-3">Hesabınızla ilgili yapılması gereken işlemler var. Lütfen ana hesap yöneticiniz ile iletişime geçin.</p>
